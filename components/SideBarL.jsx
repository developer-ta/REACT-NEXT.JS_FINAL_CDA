...
export default function SideBarL() {
  ...
  return (
    ...
    //   </div>
    // );
    <section className='fixed  flex flex-col sm:items-center outline outline-2 outline-slate-500 rounded-md  top-[90%]  w-[99%]  text-center z-30 overflow-hidden bg-gradient-to-r from-cyan-900  to-slate-900 text-stone-100 shadow-sm  shadow-orange-300 sm:static sm:w-[25%] sm:z-0'>
